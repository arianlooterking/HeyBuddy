...
No windows are shown, no native input is sent, and the running app is untouched. The shell's text-language helper is substituted because language detection is outside this sizing check. This does not claim a live multi-monitor or screen-reader test.
